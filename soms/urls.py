...
urlpatterns = [
    ...
    url(r'^deploy/file_manage/upload/ajax_upload$', dviews.salt_ajax_file_upload, name='file_upload'),
    ...
    url(r'^deploy/group_minions/$', dviews.salt_group_minions, name='get_minions'),
